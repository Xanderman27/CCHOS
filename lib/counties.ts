// Auto-generated US county data from Census Bureau
...
export const COUNTIES_BY_STATE: Record<string, readonly string[]> = {
  ...
  "Alaska": [
    "Aleutians East", "Aleutians West", "Anchorage", "Bethel",
    "Bristol Bay", "Chugach", "Copper River", "Denali",
    "Dillingham", "Fairbanks North Star", "Haines", "Hoonah-Angoon",
    "Juneau City and", "Kenai Peninsula", "Ketchikan Gateway", "Kodiak Island",
    "Kusilvak", "Lake and Peninsula", "Matanuska-Susitna", "Nome",
    "North Slope", "Northwest Arctic", "Petersburg", "Prince of Wales-Hyder",
    "Sitka City and", "Skagway", "Southeast Fairbanks", "Wrangell City and",
    "Yakutat City and", "Yukon-Koyukuk",
  ],
  "Arizona": [
  ...
  "Indiana": [
    ...
    "Crawford", "Daviess", "DeKalb", "Dearborn",
    "Decatur", "Delaware", "Dubois", "Elkhart",
  ...
  "Louisiana": [
    ...
    "Jackson", "Jefferson", "Jefferson Davis", "LaSalle",
  ...
  "Missouri": [
    ...
    "St. Louis", "St. Louis City", "Ste. Genevieve", "Stoddard",
    "Stone", "Sullivan", "Taney", "Texas",
  ...
  "South Dakota": [
    ...
    "Minnehaha", "Moody", "Oglala Lakota", "Pennington",
  ...
  "Tennessee": [
    ...
    "Crockett", "Cumberland", "Davidson", "DeKalb",
    "Decatur", "Dickson", "Dyer", "Fayette",
  ...
  "Texas": [
    ...
    "Dallas", "Dawson", "DeWitt", "Deaf Smith",
    "Delta", "Denton", "Dickens", "Dimmit",
  ...
  "Virginia": [
    ...
    "Botetourt", "Bristol City", "Brunswick", "Buchanan",
    "Buckingham", "Buena Vista City", "Campbell", "Caroline",
    "Carroll", "Charles City", "Charlotte", "Charlottesville City",
    "Chesapeake City", "Chesterfield", "Clarke", "Colonial Heights City",
    "Covington City", "Craig", "Culpeper", "Cumberland",
    "Danville City", "Dickenson", "Dinwiddie", "Emporia City",
    "Essex", "Fairfax", "Fairfax City", "Falls Church City",
    "Fauquier", "Floyd", "Fluvanna", "Franklin",
    "Franklin City", "Frederick", "Fredericksburg City", "Galax City",
    "Giles", "Gloucester", "Goochland", "Grayson",
    "Greene", "Greensville", "Halifax", "Hampton City",
    "Hanover", "Harrisonburg City", "Henrico", "Henry",
    "Highland", "Hopewell City", "Isle of Wight", "James City",
    "King George", "King William", "King and Queen", "Lancaster",
    "Lee", "Lexington City", "Loudoun", "Louisa",
    "Lunenburg", "Lynchburg City", "Madison", "Manassas City",
    "Manassas Park City", "Martinsville City", "Mathews", "Mecklenburg",
    "Middlesex", "Montgomery", "Nelson", "New Kent",
    "Newport News City", "Norfolk City", "Northampton", "Northumberland",
    "Norton City", "Nottoway", "Orange", "Page",
    ...
    "Rockbridge", "Rockingham", "Russell", "Salem City",
    "Scott", "Shenandoah", "Smyth", "Southampton",
    "Spotsylvania", "Stafford", "Staunton City", "Suffolk City",
    "Surry", "Sussex", "Tazewell", "Virginia Beach City",
    "Warren", "Washington", "Waynesboro City", "Westmoreland",
    "Williamsburg City", "Winchester City", "Wise", "Wythe",
    "York",
  ],
  "Washington": [
  ...
  "West Virginia": [
    ...
    "Marshall", "Mason", "McDowell", "Mercer",
